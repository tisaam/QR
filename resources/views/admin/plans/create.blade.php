...
@section('content')
    <style>
        ...
        /* ===========================================================
       PLAN CREATE / EDIT PAGE - DARK MODE ONLY
                        ...
                        <div class="field-grid">
                            ...
                            <div>
                                ...
                                <select name="billing_cycle">
                                    ...
                                    <option value="one_time" {{ old('billing_cycle') == 'one_time' ? 'selected' : '' }}>One
                                        Time</option>
                                </select>
                            </div>
                            <div>
                        ...
                        <div style="display:flex; flex-direction:column; gap:0.7rem;">
                            ...
                            <div>
                                ...
                                <input type="number" name="limits[reviews_per_month]"
                                    value="{{ old('limits.reviews_per_month', 0) }}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="limits[analytics_days]"
                                    value="{{ old('limits.analytics_days', 7) }}">
                            </div>
                            <div
                                ...
                                <div class="check-row"><span>WhatsApp</span><input type="checkbox" name="limits.whatsapp"
                                        value="1" {{ old('limits.whatsapp') ? 'checked' : '' }}></div>
                                ...
                                <div class="check-row"><span>NFC Support</span><input type="checkbox" name="limits.nfc"
                                        value="1" {{ old('limits.nfc') ? 'checked' : '' }}></div>
                                <div class="check-row"><span>White Label</span><input type="checkbox"
                                        name="limits.white_label" value="1" {{ old('limits.white_label') ? 'checked' : '' }}></div>
                                <div class="check-row"><span>Custom Branding</span><input type="checkbox"
                                        name="limits.custom_branding" value="1" {{ old('limits.custom_branding') ? 'checked' : '' }}></div>
                                <div class="check-row"><span>Remove Branding</span><input type="checkbox"
                                        name="limits.remove_branding" value="1" {{ old('limits.remove_branding') ? 'checked' : '' }}></div>
                            </div>
                        </div>
                    </div>
