...
<head>
   ...
   <title>Leave a Review - {{ $business->name ?? 'Us' }}</title>
    ...
    <style>
        ...
        .star-rating label { font-size: 3rem; color: #d1d5db; cursor: pointer; transition: color 0.2s; }
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <div class="bg-white shadow-sm p-4 text-center">
        ...
        @endif
        <h1 class="text-lg font-bold text-gray-800">{{ $business->name ?? 'Our Business' }}</h1>
